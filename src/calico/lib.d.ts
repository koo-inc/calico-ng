...
type arrayMapFn<T, U> = (el: T, i: number, arr: T[]) => U;
type arraySortMapFn<T, U> = (el: T) => U;
type arraySearchFn<T> = (el: T, i: number, arr: T[]) => boolean;
...
interface Array<T> {
  ...
  from(index: number): T[];
  groupBy<U>(map: string|arrayMapFn<T, U>, fn?: (arr: T[], key: string, obj: Object) => void): Object;
  ...
  last(num?: number): T;
  least<U>(all?: boolean, map?: string|arrayMapFn<T, U>): T[];
  least<U>(map?: string|arrayMapFn<T, U>): T[];
  map<U>(map: string|arrayMapFn<T, U>, context?: any): U[];
  mapFromIndex(startIndex: number, loop?: boolean, ...args: any[]): T;
  mapFromIndex(startIndex: number, ...args: any[]): T;
  max<U>(all?: boolean, map?: string|arrayMapFn<T, U>): T;
  max<U>(map?: string|arrayMapFn<T, U>): T;
  median<U>(map?: string|arrayMapFn<T, U>): number;
  min<U>(all?: boolean, map?: string|arrayMapFn<T, U>): T;
  min<U>(map?: string|arrayMapFn<T, U>): T;
  most<U>(all?: boolean, map?: string|arrayMapFn<T, U>): T[];
  most<U>(map?: string|arrayMapFn<T, U>): T[];
  none(search: T|arraySearchFn<T>, context?: any): boolean;
  ...
  remove(search: T|arraySearchFn<T>): T[];
  removeAt(start: number, end?: number): T[];
  sample(num?: number, remove?: boolean): T;
  shuffle(): T[];
  some(search: T|arraySearchFn<T>, context?: any): boolean;
  someFromIndex(startIndex: number, loop?: boolean, ...args: any[]): T;
  someFromIndex(startIndex: number, ...args: any[]): T;
  sortBy<U>(map?: string|arraySortMapFn<T, U>, desc?: boolean): T[];
  subtract(item: T|T[]): T[];
  sum<U>(map?: string|arrayMapFn<T, U>): number;
  to(index: number): T[];
  union(arr: T[]): T[];
  unique<U>(map?: string|arrayMapFn<T, U>): T[];
  zip(...args: any[]): T[];
}
...
type objectResolveFn<T> = (key: string, targetVal: T, sourceVal: T, target: Object, source: Object) => boolean;
type objectSearchFn<T> = (key: string, val: T, obj: Object) => boolean;
type objectMapFn<T, U> = (val: T, key: string, obj: Object) => U;

interface ObjectQueryStringParseOptions<T, U> {
  deep?: boolean;
  auto?: boolean;
...
interface ObjectQueryStringOptions<T, U> {
  deep?: boolean;
  prefix?: string;
  transform?: (key: string, val: T, obj: Object) => U;
  separator?: string;
...
interface ObjectMergeOptions<T> {
  ...
  hidden?: boolean;
  descriptor?: boolean;
  resolve?: boolean|objectResolveFn<T>;
}

interface ObjectConstructor {
  fromQueryString<T, U>(str: string, options?: ObjectQueryStringParseOptions<T, U>): Object;
  ...
  average<T, U>(instance: Object, map?: string|objectMapFn<T, U>): number;
  clone(instance: Object, deep?: boolean): Object;
  count<T>(instance: Object, search: T|objectSearchFn<T>): number;
  defaults<T>(instance: Object, sources: Array<Object>, options?: ObjectMergeOptions<T>): Object;
  every<T>(instance: Object, search: T|objectSearchFn<T>): boolean;
  exclude<T>(instance: Object, search: T|objectSearchFn<T>): Object;
  filter<T>(instance: Object, search: T|objectSearchFn<T>): T[];
  find<T>(instance: Object, search: T|objectSearchFn<T>): boolean;
  ...
  least<T, U>(instance: Object, all?: boolean, map?: string|objectMapFn<T, U>): T;
  least<T, U>(instance: Object, map?: string|objectMapFn<T, U>): T;
  map<T, U>(instance: Object, map: string|objectMapFn<T, U>): Object;
  max<T, U>(instance: Object, all?: boolean, map?: string|objectMapFn<T, U>): T;
  max<T, U>(instance: Object, map?: string|objectMapFn<T, U>): T;
  median<T, U>(instance: Object, map?: string|objectMapFn<T, U>): number;
  ...
  min<T, U>(instance: Object, all?: boolean, map?: string|objectMapFn<T, U>): T;
  min<T, U>(instance: Object, map?: string|objectMapFn<T, U>): T;
  most<T, U>(instance: Object, all?: boolean, map?: string|objectMapFn<T, U>): T;
  most<T, U>(instance: Object, map?: string|objectMapFn<T, U>): T;
  none<T>(instance: Object, search: T|objectSearchFn<T>): boolean;
  ...
  remove<T>(instance: Object, search: T|objectSearchFn<T>): Object;
  ...
  some<T>(instance: Object, search: T|objectSearchFn<T>): boolean;
  subtract(instance: Object, obj: Object): Object;
  sum<T, U>(instance: Object, map?: string|objectMapFn<T, U>): number;
  tap(instance: Object, fn: (obj: Object) => any): Object;
  toQueryString<T, U>(instance: Object, options?: ObjectQueryStringOptions<T, U>): Object;
